...
8. Dispatch one private `2026-08-16` run, monitor it to completion, download the artifact, and validate editorial evidence, citations, audio duration, transcript, chapters, cleanup, and unchanged public state.

## Validation Commands

- `.venv/bin/python -m pytest tests/test_editorial.py tests/test_pipeline.py`
- `.venv/bin/python -m pytest`
- `gh workflow run daily.yml -f episode_date=2026-08-16 -f shadow=true`
